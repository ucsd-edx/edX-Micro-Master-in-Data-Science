...
interact(f, s = w, height = widgets.FloatSlider(description = "Maximum height", min = 1, max = 100, value = 0.5, step = 1, continuous_update = False), CDF = widgets.ToggleButton(value = False))