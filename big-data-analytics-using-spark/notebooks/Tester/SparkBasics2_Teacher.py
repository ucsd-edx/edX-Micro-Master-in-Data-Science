...
def exercise3_1(func_student, sc):
...
def exercise3_2(func_student, sc):
...
def exercise3_3(func_student, sc):
...
def exercise3_4(func_student, sc):
...
def exercise3_5(func_student, sc):
